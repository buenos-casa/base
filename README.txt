# Description
This package is a collection of all the source code and data used to create the Buenos Casas web application. It was made using Vue.js, Bottle, and d3. Much thanks to GopherVs for simple to integrate d3 Vue components as well as online tutorial that aided in creation of the map Vue.
